...
# Access Twitter.api through Tweepy
# user has to insert their API key and other tokens
api_key = ''
api_secret = ''
acces_token = ''
acces_token_secret = ''
...
# calculate the average sentiment and subjectivity of tweets on my time line
    mood_avg = round(mood / mood_tweet_nbr, 1)
    opinion_avg = round(opinion / mood_tweet_nbr, 1)
...
mood_list = ["extremely negative", "negative", "moderate", "positive", "extremely positive", "unknown"]
opinion_list = ["totally objective", "objective", "neutral", "subjective", "highly subjective", "unknown"]
